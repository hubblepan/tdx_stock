...
if __name__=='__main__':
    # #data to phone
    data_to_tdx_phone(zxg=load_stock_code_list('tdx_tod.txt'))
    # data_to_tdx_phone(DAY0=load_stock_code_list('day0.txt'))
    # data_to_tdx_phone(DAY1=load_stock_code_list('day1.txt'))
    # data_to_tdx_phone(DAY2=load_stock_code_list('day2.txt'))
    # data_to_tdx_phone(DAY3=load_stock_code_list('day3.txt'))
    # data_to_tdx_phone(DAY4=load_stock_code_list('day4.txt'))